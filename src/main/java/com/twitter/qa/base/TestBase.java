...
public class TestBase {
	...
	public TestBase() {
		...
		prop = new Properties();
		try {
			FileInputStream propFile = new FileInputStream("C:/Users/Anuradha/eclipse-workspace/Twitter_Phase_1/src/main/java/com/twitter/"
	...
	public static void Initialization(){
		...
		if (browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver", "..\\Twitter_Phase_1\\drivers\\chromedriver\\chromedriver.exe");
			
			driver = new ChromeDriver();
		}
		else if (browserName.equals("firefox")) {
			System.setProperty("webdriver.gecko.driver", "..\\Twitter_Phase_1\\drivers\\geckodriver\\geckodriver.exe");
